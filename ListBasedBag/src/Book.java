...
public class Book
{
    ...
    /**
     * Equals method of the book to compare same title.
     * @return boolean whether its true or false.
    ...
    public boolean equals(Object o)
    {
        ...
        {
            Book typeBook = (Book) o;
            return typeBook.getTitle().equals(this.getTitle());
