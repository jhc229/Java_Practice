    ...
    implements Stack<Item>
{
    ...
    /**
     * Since the class is not static, this gives the StackIterator class
     * automatic access to all data in the ArrayStack class
     * @author sean
     *
     */
    private class StackIterator implements Iterator<Item>
    {
        //index indicating the current element in the iteration
        private int index;
        private boolean nex = false;

        /**
         * A StackIterator constructor that initializes this data.
         */
        ...
        /**
         *  method to return true if there are still elements to be
         *  processed in the iteration.
         *  @return true of false whether there is an element or not.
         */
        @Override
        ...
        /**
         * Throw a NoSuchElementException if there are no elements left
         * to process.
        ...
        public Item next()
        {
            ...
            if (index == 0)
            {
                throw new NoSuchElementException("No elements left to " +
                		"process.");
            }
    ...
    /**
     * It satisfies the new criteria of the Stack interface.
